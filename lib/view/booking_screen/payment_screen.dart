...
void initState(){
    ...
    return Scaffold(
     ...
     body: SingleChildScrollView(
      child: Column(children: [
        ...
        Image.asset('lib/assets/payment screeen.jpg',
        ...
        child: TextFormField(
          ...
          decoration: const InputDecoration(
            ...
            labelStyle: TextStyle(fontSize: 15.0,color:Color.fromARGB(255, 22, 21, 21)),
            border: OutlineInputBorder(borderSide: BorderSide(color:Color.fromARGB(255, 0, 0, 0),width: 1.0),
            ...
            enabledBorder: OutlineInputBorder(
              borderSide: BorderSide(
                color:
                Color.fromARGB(255, 8, 8, 8),width: 1.0
              )
            ),
  ...
  onPressed: () {
    if (amtcontroller.text.isNotEmpty) {
      int? amount = int.tryParse(amtcontroller.text);
      if (amount != null) {
        setState(() {
          openamount(amount);
        });
